...
tribble(
  ...
  h1, s1, w1 , t1, "Focus on customer-facing projects, delivering process improvement based analytics solutions. Produced dashboards and analytical solutions in order to support suggested improvements to customer warehouse systems.",
  
  h1, s1, w1 , t1, "Developed real-time dashboards based on warehouse throughput and operator rates that analyze warehouse systems to determine if there are bottlenecks, system health failures, and other areas to provide recommendations for improvements of operations.",
...
tribble(
  ...
  h3, s3, "Development of high-performance computing systems to make use of new computing paradigms such as parallel programming, GPU computing, clustered and cloud computing"
